...
import 'package:netplus/view/ui/widget/neworder.dart';
...
class _OfferCartState extends State<OfferCart> with TickerProviderStateMixin {
                                      ...
                                      Text.rich(
                                        ...
                                        TextSpan(
                                          children: [
                                            TextSpan(
                                              text:
                                                  '${postController.numberToBangla(sortedData[index].gb)} জিবি',
                                            ...
                                            TextSpan(
                                              text:
                                                  ' ${postController.numberToBangla(sortedData[index].minute)} মিনিট',
                                              style: const TextStyle(
                                                fontSize: 16,
                                                color: Colors.black87,
                                              ),
